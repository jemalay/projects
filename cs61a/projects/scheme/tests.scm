...
(x 'some 'thing)
; expect Error: expects a number

(define current-year 2015)
; expect current-year

(define birthday 1994)
; expect birthday
...
(eval (cons (list 'lambda '(x) '(+ x 1)) (cons 5 nil)))
; expect 6
...
(begin (print 'something) ('x))
; expect Error: cannot call: x
...
(lambda (a b) (+ a b 3))
; expect (lambda (a b) (+ a b 3))

((lambda (x y) (+ x y) (- x 1)) 5 6)
; expect 4

((lambda () 3) )
; expect 3

(define f (lambda (x) ((lambda (like emoticon) (+ x y)) 3 6)))
; expect f
...
(define ('f' x) (+ x 3))
; expect Error: quoted expression

('f' 3)
; expect Error: can't call 'f'
...
((lambda (5) (* 1 x)) 5)
; expect Error: parameter is not a symbol

((lambda (cons x y) (+ x y)) 1 2)
; expect Error: not well formed list of formals

((lambda (a b a) (+ a a)) 5 7 6)
; expect Error: repeated formal
...
;for the most part other tests cover this topic of new frames
